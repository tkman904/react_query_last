                                ...
                                <div className="col-12">
                                    <div className="single-post wow fadeInUp" data-wow-delay=".2s">
                                        <div className="post-thumb">
                                            <img src={data?.data.main.image1} style={{"width": "700px", "height": "450px"}}/>
                                        </div>
                                        <div className="post-content">
                                            ...
                                            <a href="#"><h2 className="post-headline">{data?.data.main.title}</h2></a>
                                    ...
                                    <div className="col-12 col-md-6" key={index}>
                                        <div className="single-post wow fadeInUp" data-wow-delay=".4s">
                                            ...
                                            <div className="post-content">
                                                ...
                                                <a href="#"><h4 className="post-headline">{seoul.title}</h4></a>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                    ...
                                    <div className="col-12" key={index}>
                                        <div className="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".2s">
                                            ...
                                            <div className="post-content">
                                                ...
                                                <a href="#"><h4 className="post-headline"></h4></a>
                                                <p>{busan.title}</p>
                                                <p>{busan.address}</p>
                                                <a href="#" className="read-more">Continue Reading..</a>
                                            </div>
